      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="flex items-center gap-6">
            <Link href="/generate" className="text-sm font-mono text-zinc-400 hover:text-white transition-colors">
              GENERATE
            </Link>
            <Link href="/validate" className="text-sm font-mono text-white border-b-2 border-accent pb-0.5 transition-colors">
              VALIDATE
            </Link>
          </div>
        </div>
